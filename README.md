...
Orbitron2WebSDR can also be operated in combination with MyDDENet (https://github.com/sachatholl/MyDDENet) if your WebSDR browser runs on another machine in your LAN or location (VPN).
